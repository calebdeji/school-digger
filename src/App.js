                    ...
                    <Router>
                        <nav className ="nav">
                            ...
                            <div className="nav__text-and-icon" style={{display : this.state.navTextDisplay}}>
                                ...
                                <Link to = '/pages/Contact' className="nav__text link"><FontAwesomeIcon icon={faPhoneAlt} className="icon"/>  Contact the Dev</Link>
                            </div>
                        </nav>
                        <Switch>
                            <Route path='/component/SchoolDetails' component={SchoolDetails} />
